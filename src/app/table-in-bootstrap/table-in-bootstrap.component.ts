...
@Component({
  selector: 'app-table-in-bootstrap',
  templateUrl: './table-in-bootstrap.component.html',
  styleUrls: ['./table-in-bootstrap.component.css']
})
export class TableInBootstrapComponent implements OnInit {
  documentList: any[] = [];
